class PrimaryEnergy
  ...
  updateResults: (@pathway) ->
    ...
    if null==txt
      txt = $('<div id="emissions_chart_ppd" style="margin-left: 2em;"><div style="display:inline-block; background-color:#75bf75; width:2em; height:2em; position:relative; top:0.7em; margin-right: 1em;"></div>Peak, Plateau and Decline (PPD) benchmark pathways</div>')
